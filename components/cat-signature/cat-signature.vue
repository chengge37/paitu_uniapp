...
<style lang="scss">
    ...
    .cat-signature{
        ...
        .content{display: block;position: absolute;top: 0;left: 0;bottom:0;right: 0;margin: auto; width:94%;height: 500rpx;background: #fff;border-radius: 8rpx;box-shadow: 0px 3px 3px #333;
            // canvas
            .firstCanvas {background-color: #fff;width: 100%;height: 400rpx;}
            // canvas
            
            .btns{padding: 0 15px;height: 100rpx;overflow: hidden; position: absolute;bottom: 10rpx;left: 0;right: 0;margin: auto;display: flex;justify-content: space-between;
                .btn{width: 40%;text-align: center;font-size: 28rpx;height:60rpx;line-height: 60rpx;background-color: #999;color: #fff;border-radius: 6rpx;}
            }
        }
    }
